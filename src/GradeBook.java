...
public class GradeBook extends javax.swing.JFrame {
    ...
    private void writeToCsv(String fn,String ln,String course) throws FileNotFoundException
    {
        //instantiate a csv file
        ...
        System.out.println("Saved succes");
    ...
    private void viewBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewBtnActionPerformed
        this.resultsText.setText("-----RESULTS FOR GRADE---------"
                + "\t"
                + "NAME\tCOURSE\tGRADE");
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try
        {
            this.writeToCsv(firstName, lastName, course);
        }
        catch(Exception e)
        {
